...
$fileName = "sitecore9\Sitecore-XPScaled\Sitecore Azure Toolkit 2.0.0 rev.171010.zip"
$localDirectory = "C:\Sitecore9-Install\Sitecore Azure Toolkit 2.0.0 rev.171010.zip"
$containerName = "public"
$jsonParameter = "sitecore9\Sitecore-XPScaled\azuredeploy.parameters.json"
$license  ="sitecore9\Sitecore-XPScaled\license.xml"
...
$remoteJsonPath = "https://raw.githubusercontent.com/Sitecore/Sitecore-Azure-Quickstart-Templates/master/Sitecore%209.0.0/XP/azuredeploy.json"

#Certificate Path

$CertificateFile = "C:\temp\ED4B1C6021147A88C77284E414FA1EAC57107FCC.pfx"
...
Start-SitecoreAzureDeployment -Name $resourceGroupName -Location $location -ArmTemplateUrl $remoteJsonPath  -ArmParametersPath $localarmParameterPath  -LicenseXmlPath $locallicensePath -SetKeyValue $Parameters