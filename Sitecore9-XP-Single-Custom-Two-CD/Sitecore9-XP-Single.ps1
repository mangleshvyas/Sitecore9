...
$fileName = "sitecore9\Sitecore-XP-single\Sitecore Azure Toolkit 2.0.0 rev.171010.zip"
$localDirectory = "$dir\Sitecore Azure Toolkit 2.0.0 rev.171010.zip"
$containerName = "public"
$jsonParameter = "sitecore9\Sitecore-XP-single\azuredeploy.parameters.json"
$license  ="sitecore9\Sitecore-XP-single\license.xml"
